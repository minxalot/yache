...
FalknerGroup:
	...
	db  9,  PIDGEY,     NO_ITEM, TACKLE, MUD_SLAP, QUICK_ATTACK, NO_MOVE
	db  9,  HOOTHOOT,   NO_ITEM, PECK, CONFUSION, FORESIGHT, NO_MOVE
	db  13, PIDGEOTTO,  BERRY,   TACKLE, MUD_SLAP, GUST, PROTECT
	db -1 ; end
...
BugsyGroup:
	...
	db 15, METAPOD,    NO_ITEM,  TACKLE, NO_MOVE, NO_MOVE, NO_MOVE
	db 15, KAKUNA,     NO_ITEM,  POISON_STING, STRING_SHOT, NO_MOVE, NO_MOVE
	db 14, HERACROSS,  NO_ITEM,  TACKLE, ROCK_SMASH, FURY_CUTTER, ENDURE
	db 17, SCYTHER,    BERRY,    QUICK_ATTACK, PURSUIT, FURY_CUTTER, LEER
	db -1 ; end
...
MortyGroup:
	...
	db 21, HAUNTER,    NO_ITEM,     HYPNOSIS, NIGHT_SHADE, CURSE, NIGHTMARE
	db 25, GENGAR,     GOLD_BERRY,  HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
	db 23, MISDREAVUS, NO_ITEM,     SPITE, MEAN_LOOK, CONFUSE_RAY, PSYBEAM
	db -1 ; end

PryceGroup:
	; PRYCE (1)
	db "PRYCE@", TRAINERTYPE_ITEM_MOVES
	db 33, LAPRAS,    NO_ITEM,    SURF, CONFUSE_RAY, SING, RAIN_DANCE
	db 34, DEWGONG,   NO_ITEM,    ICE_BEAM, REST, SLEEP_TALK, SURF
	db 35, JYNX,      NO_ITEM,    ICE_PUNCH, PSYCHIC_M, LOVELY_KISS, RAIN_DANCE
	db 37, PILOSWINE, GOLD_BERRY, SLEEP_TALK, EARTHQUAKE, REST, BLIZZARD
	db -1 ; end

JasmineGroup:
	; JASMINE (1)
	db "JASMINE@", TRAINERTYPE_ITEM_MOVES
	db 31, MAGNETON,   NO_ITEM,    THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 32, FORRETRESS, NO_ITEM,    SELFDESTRUCT, SPIKES, HEADBUTT, GIGA_DRAIN
	db 33, SKARMORY,   NO_ITEM,    STEEL_WING, SANDSTORM, DRILL_PECK, WHIRLWIND
...
ChuckGroup:
	...
	db 30, HITMONTOP, NO_ITEM,     QUICK_ATTACK, ROLLING_KICK, DIG, PURSUIT
...
ClairGroup:
	...
	db 38, GYARADOS,  NO_ITEM,     BITE, THUNDER, HYDRO_PUMP, RAIN_DANCE
	db 38, DRAGONAIR, NO_ITEM,     THUNDER_WAVE, THUNDER, FLAMETHROWER, DRAGONBREATH
	db 38, DRAGONAIR, NO_ITEM,     THUNDER_WAVE, FIRE_BLAST, THUNDERBOLT, OUTRAGE
	db 41, KINGDRA,   GOLD_BERRY,  SMOKESCREEN, SURF, BLIZZARD, DRAGONBREATH
	db -1 ; end

Rival1Group:
	; RIVAL1 (1) (Cherrygrove, Chiko)
	db "?@", TRAINERTYPE_NORMAL
	db  5, CHIKORITA
	db -1 ; end

	; RIVAL1 (2) (Cherrygrove, Cynda)
	db "?@", TRAINERTYPE_NORMAL
	db  5, CYNDAQUIL
	db -1 ; end

	; RIVAL1 (3) (Cherrygrove, Toto)
	db "?@", TRAINERTYPE_NORMAL
	db  5, TOTODILE
	db -1 ; end

	; RIVAL1 (4) (Azalea, Chiko)
	db "?@", TRAINERTYPE_NORMAL
	db 14, ZUBAT
	db 16, TEDDIURSA
	db 18, BAYLEEF
	...
	; RIVAL1 (7) (Burned Tower, Chiko)
	db "?@", TRAINERTYPE_MOVES
	db 20, GOLBAT,     LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	db 20, TEDDIURSA,  SCRATCH, FURY_SWIPES, FAINT_ATTACK, LICK
	db 18, HOUNDOUR,   EMBER, BITE, SMOG, ROAR
	db 18, HORSEA,     WATER_GUN, ICY_WIND, SMOKESCREEN, TWISTER
	db 22, BAYLEEF,    SYNTHESIS, REFLECT, RAZOR_LEAF, POISONPOWDER
	db -1 ; end

	; RIVAL1 (8) (Burned Tower, Cynda)
	db "?@", TRAINERTYPE_MOVES
	db 20, GOLBAT,     LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	db 20, TEDDIURSA,  SCRATCH, FURY_SWIPES, FAINT_ATTACK, LICK
	db 18, MAGNEMITE,  TACKLE, THUNDERSHOCK, SUPERSONIC, SONICBOOM
	db 18, HOUNDOUR,   EMBER, BITE, SMOG, ROAR
	db 22, QUILAVA,    LEER, MUD_SLAP, EMBER, QUICK_ATTACK
	db -1 ; end

	; RIVAL1 (9) (Burned Tower, Toto)
	db "?@", TRAINERTYPE_MOVES
	db 20, GOLBAT,     LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	db 20, TEDDIURSA,  SCRATCH, FURY_SWIPES, FAINT_ATTACK, LICK
	db 18, MAGNEMITE,  TACKLE, THUNDERSHOCK, SUPERSONIC, SONICBOOM
	db 18, HOUNDOUR,   EMBER, BITE, SMOG, ROAR
	db 22, CROCONAW,   RAGE, ICY_WIND, WATER_GUN, BITE
	db -1 ; end

	; RIVAL1 (10) (Radio Tower, Chiko)
	db "?@", TRAINERTYPE_MOVES
	db 33, GOLBAT,     SLUDGE_BOMB, BITE, CONFUSE_RAY, WING_ATTACK
	db 30, LARVITAR,   BITE, LEER, MUD_SLAP, ROCK_SLIDE
	db 32, HOUNDOOM,   EMBER, FAINT_ATTACK, HEADBUTT, ROAR
	db 32, SEADRA,     WATER_GUN, TWISTER, ICY_WIND, SMOKESCREEN
	db 30, URSARING,   HEADBUTT, DIG, LICK, CURSE
	db 34, MEGANIUM,   REFLECT, GIGA_DRAIN, POISONPOWDER, BODY_SLAM
	db -1 ; end

	; RIVAL1 (11) (Radio Tower, Cynda)
	db "?@", TRAINERTYPE_MOVES
	db 33, GOLBAT,     SLUDGE_BOMB, BITE, CONFUSE_RAY, WING_ATTACK
	db 30, LARVITAR,   BITE, LEER, MUD_SLAP, ROCK_SLIDE
	db 32, MAGNETON,   THUNDER_WAVE, THUNDERSHOCK, SUPERSONIC, SWIFT
	db 32, SEADRA,     WATER_GUN, TWISTER, ICY_WIND, SMOKESCREEN
	db 30, URSARING,   HEADBUTT, DIG, LICK, CURSE
	db 34, TYPHLOSION, THUNDERPUNCH, FLAME_WHEEL, SWIFT, ROCK_SMASH
	db -1 ; end

	; RIVAL1 (12) (Radio Tower, Toto)
	db "?@", TRAINERTYPE_MOVES
	db 32, GOLBAT,     SLUDGE_BOMB, BITE, CONFUSE_RAY, WING_ATTACK
	db 30, LARVITAR,   BITE, LEER, MUD_SLAP, ROCK_SLIDE
	db 32, MAGNETON,   THUNDER_WAVE, THUNDERSHOCK, SUPERSONIC, SWIFT
	db 32, HOUNDOOM,   EMBER, FAINT_ATTACK, HEADBUTT, ROAR
	db 30, URSARING,   HEADBUTT, DIG, LICK, CURSE
	db 34, FERALIGATR, ICE_PUNCH, SURF, BITE, ROCK_SMASH
	db -1 ; end

	; RIVAL1 (13) (Victory Road, Chiko)
	db "?@", TRAINERTYPE_MOVES
	db 36, CROBAT,     SLUDGE_BOMB, STEEL_WING, CONFUSE_RAY, WING_ATTACK
	db 38, URSARING,   STRENGTH, EARTHQUAKE, THUNDERPUNCH, CURSE
	db 37, PUPITAR,    ROCK_SLIDE, SCREECH, THRASH, EARTHQUAKE
	db 37, KINGDRA,    SURF, DRAGONBREATH, ICE_BEAM, SMOKESCREEN
	db 37, HOUNDOOM,   FLAMETHROWER, FAINT_ATTACK, SHADOW_BALL, ROAR
	db 40, MEGANIUM,   REFLECT, GIGA_DRAIN, SYNTHESIS, BODY_SLAM
	db -1 ; end

	; RIVAL1 (14) (Victory Road, Cynda)
	db "?@", TRAINERTYPE_MOVES
	db 36, CROBAT,     SLUDGE_BOMB, STEEL_WING, CONFUSE_RAY, WING_ATTACK
	db 38, URSARING,   STRENGTH, EARTHQUAKE, THUNDERPUNCH, CURSE
	db 37, PUPITAR,    ROCK_SLIDE, SCREECH, THRASH, EARTHQUAKE
	db 37, KINGDRA,    SURF, DRAGONBREATH, ICE_BEAM, SMOKESCREEN
	db 37, MAGNETON,   THUNDERBOLT, THUNDER_WAVE, SUPERSONIC, SWIFT
	db 40, TYPHLOSION, FLAMETHROWER, THUNDERPUNCH, SWIFT, DIG
	db -1 ; end

	; RIVAL1 (15) (Victory Road, Toto)
	db "?@", TRAINERTYPE_MOVES
	db 36, CROBAT,     SLUDGE_BOMB, STEEL_WING, CONFUSE_RAY, WING_ATTACK
	db 38, URSARING,   STRENGTH, EARTHQUAKE, THUNDERPUNCH, CURSE
	db 37, PUPITAR,    ROCK_SLIDE, SCREECH, THRASH, EARTHQUAKE
	db 37, HOUNDOOM,   FLAMETHROWER, FAINT_ATTACK, SHADOW_BALL, ROAR
	db 37, MAGNETON,   THUNDERBOLT, THUNDER_WAVE, SUPERSONIC, SWIFT
	db 40, FERALIGATR, SURF, ICE_PUNCH, EARTHQUAKE, SLASH
	db -1 ; end
...
WillGroup:
	...
	db 40, XATU,       HAZE, FUTURE_SIGHT, CONFUSE_RAY, PSYCHIC_M
	db 41, JYNX,       BUBBLEBEAM, LOVELY_KISS, ICE_BEAM, PSYCHIC_M
	db 41, EXEGGUTOR,  SUBSTITUTE, LEECH_SEED, GIGA_DRAIN, PSYCHIC_M
	db 41, SLOWBRO,    SURF, THUNDER_WAVE, FIRE_BLAST, PSYCHIC_M
	db 42, XATU,       REST, SLEEP_TALK, DRILL_PECK, PSYCHIC_M
	db -1 ; end
...
BrunoGroup:
	...
	db 42, HITMONTOP,  NO_ITEM,   DIG, QUICK_ATTACK, HI_JUMP_KICK, COUNTER
	db 42, HITMONLEE,  NO_ITEM,   SWAGGER, FOCUS_ENERGY, HI_JUMP_KICK, BODY_SLAM
	db 42, HITMONCHAN, NO_ITEM,   THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, MACH_PUNCH
	db 43, STEELIX,    NO_ITEM,   EARTHQUAKE, ROCK_SLIDE, ROAR, CURSE
	db 46, MACHAMP,    LEFTOVERS, ROCK_SLIDE, FORESIGHT, VITAL_THROW, CROSS_CHOP
	db -1 ; end

KarenGroup:
	; KAREN (1)
	db "KAREN@", TRAINERTYPE_ITEM_MOVES
	db 42, UMBREON,   LEFTOVERS,    FAINT_ATTACK, CONFUSE_RAY, PSYCHIC_M, MOONLIGHT
	db 42, VILEPLUME, NO_ITEM,      STUN_SPORE, SLUDGE_BOMB, MOONLIGHT, GIGA_DRAIN
	db 45, GENGAR,    NO_ITEM,      HYPNOSIS, THUNDERBOLT, ICE_PUNCH, DESTINY_BOND
	db 44, MURKROW,   NO_ITEM,      DRILL_PECK, WHIRLWIND, PURSUIT, FAINT_ATTACK
	db 47, HOUNDOOM,  BLACKGLASSES, ROAR, SLUDGE_BOMB, FLAMETHROWER, CRUNCH
	db -1 ; end

KogaGroup:
	; KOGA (1)
	db "KOGA@", TRAINERTYPE_MOVES
	db 40, ARIADOS,    POISON_BARB,  SLUDGE_BOMB, SPIDER_WEB, BATON_PASS, DOUBLE_TEAM
	db 41, VENOMOTH,   NO_ITEM,      GIGA_DRAIN, SLUDGE_BOMB, PSYCHIC_M, SLEEP_POWDER
	db 43, FORRETRESS, NO_ITEM,      PROTECT, TOXIC, EXPLOSION, SPIKES
	db 42, MUK,        NO_TTEM,      CURSE, SLUDGE_BOMB, FIRE_BLAST, ICE_PUNCH
	db 44, CROBAT,     SHARP_BEAK,   PURSUIT, QUICK_ATTACK, WING_ATTACK, SUBSTITUTE
	db -1 ; end

ChampionGroup:
	; CHAMPION (1)
	db "LANCE@", TRAINERTYPE_ITEM_MOVES
	db 46, GYARADOS, NO_ITEM,  RAIN_DANCE, SURF, ICE_BEAM, BODY_SLAM
	db 49, DRAGONITE, NO_ITEM, THUNDER_WAVE, RAIN_DANCE, THUNDER, DRAGONBREATH
	db 49, DRAGONITE, NO_ITEM,  THUNDER_WAVE, SAFEGUARD, BLIZZARD, DRAGONBREATH
	db 48, AERODACTYL, NO_ITEM, WING_ATTACK, EARTHQUAKE, ROCK_SLIDE, FIRE_BLAST
	db 48, CHARIZARD,  NO_ITEM,   FLAMETHROWER, ROCK_SLIDE, SLASH, EARTHQUAKE
	db 50, DRAGONITE,  LEFTOVERS,  OUTRAGE, EXTREMESPEED, FIRE_BLAST, HYPER_BEAM
	db -1 ; end

BrockGroup:
	; BROCK (1)
	db "BROCK@", TRAINERTYPE_ITEM_MOVES ; add items later
	db 51, GRAVELER, NO_ITEM,  DEFENSE_CURL, ROCK_SLIDE, ROLLOUT, EARTHQUAKE
	db 51, RHYHORN,  NO_ITEM,  ROCK_SLIDE, ROAR, EARTHQUAKE, REVERSAL
	db 53, OMASTAR,  NO_ITEM   ANCIENTPOWER, SURF, PROTECT, ICE_BEAM
	db 54, ONIX,     NO_ITEM,  EXPLOSION, ROCK_SLIDE, EARTHQUAKE, CURSE
	db 52, KABUTOPS, NO_ITEM,  SWORDS_DANCE, ROCK_SLIDE, HYDRO_PUMP, EARTHQUAKE
	db -1 ; end

MistyGroup:
	; MISTY (1)
	db "MISTY@", TRAINERTYPE_ITEM_MOVES
	db 49, GOLDUCK,  NO_ITEM,   ICE_BEAM, LIGHT_SCREEN, HYPNOSIS, PSYCHIC_M
	db 49, QUAGSIRE, NO_ITEM,   SURF, SLUDGE_BOMB, EARTHQUAKE, BODY_SLAM
	db 52, LAPRAS,   NO_ITEM,   REST, SLEEP_TALK, SURF, ICE_BEAM
	db 54, STARMIE,  LEFTOVERS, SURF, THUNDERBOLT, PSYCHIC_M, ICE_BEAM
	db -1 ; end

LtSurgeGroup:
	; LT_SURGE (1)
	db "LT.SURGE@", TRAINERTYPE_ITEM_MOVES ; add items later
	db 51, RAICHU,     NO_ITEM,      THUNDER_WAVE, QUICK_ATTACK, RAIN_DANCE, THUNDER
	db 47, ELECTRODE,  NO_ITEM,      REFLECT, LIGHT_SCREEN, THUNDER_WAVE, THUNDERBOLT
	db 48, MAGNETON,   NO_ITEM,      LOCK_ON, SUBSTITUTE, THUNDER_WAVE, ZAP_CANNON
	db 47, ELECTRODE,  MIRACLEBERRY, SCREECH, DOUBLE_TEAM, THUNDER, EXPLOSION
	db 53, ELECTABUZZ, NO_ITEM,      THUNDERBOLT, PSYCHIC_M, ICE_PUNCH, PURSUIT
	db -1 ; end
...
ErikaGroup:
	...
	db 51, JUMPLUFF,   STUN_SPORE, LEECH_SEED, PROTECT, GIGA_DRAIN
...
SabrinaGroup:
	...
	db 53, ESPEON,     MORNING_SUN, QUICK_ATTACK, SHADOW_BALL, PSYCHIC_M
	db 53, MR__MIME,   SUBSTITUTE, REFLECT, BATON_PASS, PSYCHIC_M
	db 55, ALAKAZAM,   RECOVER, ICE_PUNCH, PSYCHIC_M, THUNDERPUNCH
	db -1 ; end
...
Rival2Group:
	; RIVAL2 (1) (Mt Moon, Chiko)
	db "?@", TRAINERTYPE_MOVES
	db 46, CROBAT,     SLUDGE_BOMB, STEEL_WING, CONFUSE_RAY, WING_ATTACK
	db 47, HOUNDOOM,   FLAMETHROWER, FAINT_ATTACK, SHADOW_BALL, ROAR
	db 47, KINGDRA,    SURF, DRAGONBREATH, ICE_BEAM, SMOKESCREEN
	db 48, PUPITAR,    ROCK_SLIDE, SCREECH, CRUNCH, EARTHQUAKE
	db 48, URSARING,   STRENGTH, EARTHQUAKE, THUNDERPUNCH, CURSE
	db 50, MEGANIUM,   REFLECT, GIGA_DRAIN, SYNTHESIS, BODY_SLAM
	db -1 ; end

	; RIVAL2 (2) (Mt Moon, Cynda)
	db "?@", TRAINERTYPE_MOVES
	db 46, CROBAT,     SLUDGE_BOMB, STEEL_WING, CONFUSE_RAY, WING_ATTACK
	db 47, KINGDRA,    SURF, DRAGONBREATH, ICE_BEAM, SMOKESCREEN
	db 47, MAGNETON,   THUNDERBOLT, THUNDER_WAVE, SUPERSONIC, SWIFT
	db 48, PUPITAR,    ROCK_SLIDE, SCREECH, CRUNCH, EARTHQUAKE
	db 48, URSARING,   STRENGTH, EARTHQUAKE, THUNDERPUNCH, CURSE
	db 50, TYPHLOSION, FLAMETHROWER, THUNDERPUNCH, SWIFT, EARTHQUAKE
	db -1 ; end

	; RIVAL2 (3) (Mt Moon, Toto)
	db "?@", TRAINERTYPE_MOVES
	db 46, CROBAT,     SLUDGE_BOMB, STEEL_WING, CONFUSE_RAY, WING_ATTACK
	db 47, HOUNDOOM,   FLAMETHROWER, FAINT_ATTACK, SHADOW_BALL, ROAR
	db 47, MAGNETON,   THUNDERBOLT, THUNDER_WAVE, SUPERSONIC, SWIFT
	db 48, PUPITAR,    ROCK_SLIDE, SCREECH, CRUNCH, EARTHQUAKE
	db 48, URSARING,   STRENGTH, EARTHQUAKE, THUNDERPUNCH, CURSE
	db 50, FERALIGATR, SURF, ICE_BEAM, EARTHQUAKE, ROCK_SLIDE
	db -1 ; end

	; RIVAL2 (4) (Rematch, Chiko)
	db "?@", TRAINERTYPE_MOVES
	db 55, CROBAT,     SLUDGE_BOMB, STEEL_WING, CONFUSE_RAY, WING_ATTACK
	db 56, HOUNDOOM,   FLAMETHROWER, FAINT_ATTACK, SHADOW_BALL, ROAR
	db 56, KINGDRA,    SURF, DRAGONBREATH, ICE_BEAM, SMOKESCREEN
	db 58, TYRANITAR,  ROCK_SLIDE, SCREECH, CRUNCH, EARTHQUAKE
	db 58, URSARING,   STRENGTH, EARTHQUAKE, THUNDERPUNCH, CURSE
	db 60, MEGANIUM,   REFLECT, GIGA_DRAIN, SYNTHESIS, BODY_SLAM
	db -1 ; end

	; RIVAL2 (5) (Rematch, Cynda)
	db "?@", TRAINERTYPE_MOVES
	db 55, CROBAT,     SLUDGE_BOMB, STEEL_WING, CONFUSE_RAY, WING_ATTACK
	db 56, KINGDRA,    SURF, DRAGONBREATH, ICE_BEAM, SMOKESCREEN
	db 56, MAGNETON,   THUNDERBOLT, THUNDER_WAVE, SUPERSONIC, SWIFT
	db 58, TYRANITAR,  ROCK_SLIDE, SCREECH, CRUNCH, EARTHQUAKE
	db 58, URSARING,   STRENGTH, EARTHQUAKE, THUNDERPUNCH, CURSE
	db 60, TYPHLOSION, FLAMETHROWER, THUNDERPUNCH, SWIFT, EARTHQUAKE
	db -1 ; end

	; RIVAL2 (6) (Rematch, Toto)
	db "?@", TRAINERTYPE_MOVES
	db 55, CROBAT,     SLUDGE_BOMB, STEEL_WING, CONFUSE_RAY, WING_ATTACK
	db 56, HOUNDOOM,   FLAMETHROWER, FAINT_ATTACK, SHADOW_BALL, ROAR
	db 56, MAGNETON,   THUNDERBOLT, THUNDER_WAVE, SUPERSONIC, SWIFT
	db 58, TYRANITAR,  ROCK_SLIDE, SCREECH, CRUNCH, EARTHQUAKE
	db 58, URSARING,   STRENGTH, EARTHQUAKE, THUNDERPUNCH, CURSE
	db 60, FERALIGATR, SURF, ICE_BEAM, EARTHQUAKE, ROCK_SLIDE
	db -1 ; end
...
RedGroup:
	...
	db 88, PIKACHU,   LIGHT_BALL, SUBSTITUTE, QUICK_ATTACK, SURF, THUNDERBOLT
	db 80, ESPEON,    NO_ITEM,    BATON_PASS, REFLECT, GROWTH, PSYCHIC_M
	db 82, SNORLAX,   LEFTOVERS,  CURSE, EARTHQUAKE, REST, BODY_SLAM
	db 84, VENUSAUR,  NO_ITEM,    LEECH_SEED, GIGA_DRAIN, SYNTHESIS, SLEEP_POWDER
	db 84, CHARIZARD, NO_ITEM,    FLAMETHROWER, WING_ATTACK, EARTHQUAKE, ROCK_SLIDE
	db 84, BLASTOISE, NO_ITEM,    RAIN_DANCE, SURF, BLIZZARD, EARTHQUAKE
	db -1 ; end
...
BlueGroup:
	...
	db 56, ALAKAZAM,   THUNDERPUNCH, RECOVER, PSYCHIC_M, REFLECT
	db 58, RHYDON,     CURSE, SURF, ROCK_SLIDE, EARTHQUAKE
	db 60, GYARADOS,   THUNDER, HYDRO_PUMP, RAIN_DANCE, ROAR
	db 60, EXEGGUTOR,  SLEEP_POWDER, LEECH_SEED, PSYCHIC, EXPLOSION
	db 60, ARCANINE,   ROAR, BODY_SLAM, FLAMETHROWER, EXTREMESPEED
	db -1 ; end
