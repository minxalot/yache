	...
	const ECRUTEAKPOKECENTER1F_TRADEBACKNPC
...
EcruteakPokecenter1F_MapEvents:
	...
	object_event  5,  3, SPRITE_FISHER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, TradebackNPCScript, -1
