...
FalknerGroup:
	...
	db  13, PIDGEOTTO,  TACKLE, MUD_SLAP, GUST, PROTECT
	db -1 ; end
...
BugsyGroup:
	...
	db 15, KAKUNA,  NO_ITEM,  POISON_STING, HARDEN, NO_MOVE, NO_MOVE
	db 17, SCYTHER, BERRY,    QUICK_ATTACK, LEER, FURY_CUTTER, FOCUS_ENERGY
	db -1 ; end
...
MortyGroup:
	...
	db 21, HAUNTER, NO_ITEM,     HYPNOSIS, DREAM_EATER, CURSE, NIGHTMARE
	db 25, GENGAR,  GOLD_BERRY,  HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
	db 23, HAUNTER, NO_ITEM,     CURSE, MEAN_LOOK, SPITE, NIGHT_SHADE
	db -1 ; end

PryceGroup:
	; PRYCE (1)
	db "PRYCE@", TRAINERTYPE_ITEM_MOVES
	db 30, SEEL,      NO_ITEM,   ICY_WIND, REST, SNORE, SAFEGUARD
	db 32, DEWGONG,   NO_ITEM,   AURORA_BEAM, REST, SLEEP_TALK, SURF
...
ClairGroup:
	...
	db 38, GYARADOS,  NO_ITEM,     BITE, DRAGON_RAGE, HYDRO_PUMP, RAIN_DANCE
	db 38, DRAGONAIR, NO_ITEM,     THUNDER_WAVE, THUNDER, SLAM, OUTRAGE
	db 38, DRAGONAIR, NO_ITEM,     THUNDER_WAVE, FIRE_BLAST, SLAM, OUTRAGE
	db 41, KINGDRA,   GOLD_BERRY,  SMOKESCREEN, HYDRO_PUMP, BLIZZARD, DRAGONBREATH
	db -1 ; end
