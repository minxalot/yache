...
BrunoGroup:
	...
	db 46, MACHAMP,    LEFTOVERS, ROCK_SLIDE, FORESIGHT, EARTHQUAKE, CROSS_CHOP
	db -1 ; end

KarenGroup:
	; KAREN (1)
	db "KAREN@", TRAINERTYPE_ITEM_MOVES
	db 42, UMBREON,   NO_ITEM,      FAINT_ATTACK, TOXIC, PROTECT, MOONLIGHT
...
KogaGroup:
	...
	db 40, VENOMOTH,   POISON_BARB,  GIGA_DRAIN, SLUDGE_BOMB, PSYCHIC_M, SLEEP_POWDER
	db 41, TENTACRUEL, NO_ITEM,      SWORDS_DANCE, SUBSTITUTE, SLUDGE_BOMB, SURF
	db 43, FORRETRESS, NO_ITEM,      PROTECT, TOXIC, EXPLOSION, SPIKES
	db 42, MUK,        NO_TTEM,      CURSE, SLUDGE_BOMB, MINIMIZE, ICE_PUNCH
	db 44, CROBAT,     SHARP_BEAK,   PURSUIT, TOXIC, WING_ATTACK, SUBSTITUTE
	db -1 ; end
